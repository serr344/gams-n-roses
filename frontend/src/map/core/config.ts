...
export const CONFIG = {
  ...
  OPTIM_RADIUS: 600,
  BUILDING_TYPES: [
    { type: "Merkezi Park", w: 800, h: 800, db: 0, color: "#2d7a1f", maxCount: 1, minDist: 9999, imgIcon: "cimen.png" },
    ...
    { type: "fire", w: 280, h: 169, db: 40, color: "#ff1a1a", maxCount: 5, minDist: 400, imgIcon: "fire.png" },
    { type: "police", w: 280, h: 182, db: 40, color: "#ff1a1a", maxCount: 5, minDist: 400, imgIcon: "police.png" },
    { type: "Büyük Park", w: 380, h: 256, db: 0, color: "#3a8a2a", maxCount: 10, minDist: 400, imgIcon: "cimen.png" },
    { type: "Küçük Park", w: 240, h: 128, db: 0, color: "#4a9a3a", maxCount: 18, minDist: 200, imgIcon: "cimen.png" },
    ...
    { type: "Müstakil Ev", w: 120, h: 83, db: 45, color: "#b3ffcc", maxCount: Infinity, minDist: 0, prob: 0.30, isFiller: true, imgIcon: "residence.png" },
    { type: "Çeşitli Mağazalar", w: 60, h: 36, db: 65, color: "#ffff66", maxCount: Infinity, minDist: 0, prob: 0.15, isFiller: true, imgIcon: "shop.png" },
    { type: "shop", w: 60, h: 36, db: 60, color: "#ff99cc", maxCount: Infinity, minDist: 0, prob: 0.15, isFiller: true, imgIcon: "cafe.png" },
