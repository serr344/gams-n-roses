...
- 💰 Budget limitations
- 🔊 Noise restrictions
- 🏙️ Building sensitivity levels
- 🎯 Strategic item placement

Different buildings tolerate different sound levels.  
For example:

- Library → low tolerance
- Park → higher tolerance
...
- Player score is shown
- GAMSPy optimal score is shown
